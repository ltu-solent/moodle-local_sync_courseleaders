 ...
 *
 * @module     local_sync_courseleaders/form-course-selector
...
define(['core/ajax', 'jquery'], function(ajax, $) {
    ...
    return {
        ...
        transport: function(selector, query, success, failure) {
            let enabled = document.querySelector('#id_enabled');
            var promises = null;
            ...
            var calls = [{
                methodname: 'local_sync_courseleaders_search_courses', args: searchargs
            }];
